...
paac.startpage.beforeInfo.p3=Before you start you need to know: <ul class="list-bullet"><li>the types of pension schemes you’ve had and how much has been saved in them for the dates you want to check</li><li>if you have ever flexibly accessed your pension savings, when you first did this, and the amount of Defined Benefit pension savings for rest of the pension input period after this date</li><li>if your <a href="https://www.gov.uk/guidance/pension-schemes-work-out-your-tapered-annual-allowance">threshold income is more than £110,000 and if your adjusted income is more than £150,000</a> when checking tax years from 2016/2017</li></ul>
...
pre2015.error.required= Enter your total amount for this year even if it is 0.
...
paac.benefit= benefit
paac.contribution= contribution
...
paac.pension.inputs.totalamount = Enter amount
...
paac.review-amounts.heading.trigger.savings.p1=Your defined contribution savings after {0}
paac.review-amounts.heading.trigger.savings.p2=Your defined contribution savings after {0}
paac.review-amounts.heading.trigger.savings.other=Your defined contribution savings after {0}
...
paac.review-amounts.error.negative-trigger=The flexible access amount provided now exceeds the defined contribution savings for the {0} pension input period. Please edit <span style="font-weight:bolder">either</span> the defined contributions savings or the flexible access savings as appropriate for your circumstances.
...
paac.post.trigger.value.error = Enter an amount less than your total pension savings of £{0}

paac.post.trigger.amount.input.label = Enter amount
...
paac.201617.pension.inputs.heading = What were your pension savings in the tax year {0} to {1}?
