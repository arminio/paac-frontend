...
class YesNo1516Period1ControllerSpec extends UnitSpec with BeforeAndAfterAll {
  ...
  "YesNo1516Period1Controller" when {
    ...
    "onSubmit with POST request" should {
      ...
      "with valid yesnoFor1516P1 should save to keystore" in new ControllerWithMockKeystore{
        // set up
